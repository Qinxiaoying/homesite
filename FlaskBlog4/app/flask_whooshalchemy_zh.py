...
"""
    Use ChineseAnalyzer from jieba instead of the default analyzer
    Renamed as flask_whooshalchemy_zh.py
"""
    ...
    for field in model.__table__.columns:
        ...
        if field.name in searchable and isinstance(field.type,
            ...
            schema[field.name] = whoosh.fields.TEXT(
                    analyzer=ChineseAnalyzer())### support for Chinese ### instead of StemmingAnalyzer() ###
